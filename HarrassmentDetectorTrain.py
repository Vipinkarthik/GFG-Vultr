...
extract_frames("Harrassment video.mp4", label="harassment", output_dir="frames")
extract_frames("NonHarrassment video.mp4", label="non_harassment", output_dir="frames")
def load_data(data_dir, target_size=(160, 160)):
    ...
    for label in ["harassment", "non_harassment"]:
        ...
        for filename in os.listdir(label_dir):
            ...
            labels.append(1 if label == "harassment" else 0)
...
model.save("harassment_detector_model.h5")
print("Model saved as 'harassment_detector_model.h5'")
